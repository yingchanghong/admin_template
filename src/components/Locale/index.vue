  ...
  <el-dropdown>
    ...
    <template #dropdown>
      <el-dropdown-menu :split-button="true">
        <el-dropdown-item v-for="item in Locale" :key="item.value" @click="changeLocale(item.value)">{{ item.label }}</el-dropdown-item>
      </el-dropdown-menu>
    </template>
  </el-dropdown>
</template>
