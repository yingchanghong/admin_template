<template>
  ...
  <el-form v-show="getShow" :model="formData">
    <el-form-item>
      <el-input class="animate-delay-100 animate-fade-in-right animate-duration-500" v-model="formData.name" @keypress.enter="handleLogin" :placeholder="t('login.loginNamePlacehodel')" clearable animate-delay-100 />
    </el-form-item>
    <el-form-item>
    ...
    <el-form-item>
      ...
      <el-button class="animate-delay-500 animate-fade-in-right animate-duration-500" type="default" @click="setLoginState(LoginStateEnum.QR_CODE)" animate-delay-500>{{ t('login.qrCodeLogin') }}</el-button>
      <el-button class="animate-delay-600 animate-fade-in-right animate-duration-500" animate- type="default" @click="setLoginState(LoginStateEnum.REGISTER)">{{ t('login.registerText') }}</el-button>
    </el-form-item>
  </el-form>
</template>
